...
export default function Productspopup({ onSave, onCancel, products: initialProducts }) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div ref={popupRef} className="bg-white rounded-lg shadow-lg overflow-hidden max-w-md w-full">
        ...
        <div className="p-4">
          {products.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-24 px-8 text-center">
              ...
              <p className="text-gray-500 mb-4">Select the products to be displayed on your store.</p>
              <Button
                ...
                <div key={product.id} className="border border-gray-200 rounded-lg p-4 relative group">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600">{product.price || 'No price set'}</p>
                    </div>
                  </div>
