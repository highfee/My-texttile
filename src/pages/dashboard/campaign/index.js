...
import { ArrowDown, ArrowLeft, ArrowUp, Shapes } from "lucide-react";
import { LuSquareArrowUp } from "react-icons/lu";
import { IoIosArrowDown } from "react-icons/io";
import { CampaignCards } from "@/components/dashboard/Layout/Headercomponents/CampaignCards";
import { CampaignDetails } from "@/components/dashboard/Layout/Headercomponents/CampaignDetails";
import { ApprovalPage } from "@/components/dashboard/Layout/Headercomponents/ApprovalPage";
import { CampaignForm } from "@/components/dashboard/Layout/Headercomponents/CampaignForm";
    ...
    <div className="lg:p-6 min-h-screen flex flex-col gap-y-4 px-2 lg:px-10">
      ...
      {selectedSubmission ? (
        ...
        <div className="space-y-6">
          ...
          >
            <ArrowLeft className="transform rotate-270 mr-2" />
            Back to Campaigns
          </button>
          <CampaignForm onClose={handleBackFromForm} />
        </div>
      ) : selectedCampaign ? (
        <CampaignDetails 
        ...
        <>
          {/* Default Campaign Dashboard View */}
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 lg:gap-6">
              <div className="col-span-2 flex flex-col gap-6">
                  ...
                  <div className="flex flex-col gap-y-8">
                    <div className="flex items-center gap-4 bg-white p-4 rounded-xl shadow-md w-80">
                      ...
                      <div className="flex flex-col">
                        <h2 className="text-gray-600 font-semibold text-sm">Total Votes</h2>
                    ...
                    <div className="flex items-center gap-4 bg-white p-4 rounded-xl shadow-md w-80">
                      ...
                      <div className="flex flex-col">
                        <h2 className="text-gray-600 font-semibold text-sm">Appr. Design</h2>
                ...
                <CampaignCards onCardClick={handleCardClick} />
              </div>
